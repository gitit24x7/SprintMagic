                  ...
                  <div className="md:border-r border-stone-200 flex flex-col divide-y divide-stone-200">
                    {FEATURES.map((f, i) => (
                      <button
                        ...
                        className={`relative isolate flex items-start gap-4 p-6 text-left cursor-pointer flex-grow transition-colors ${activeFeature === i ? 'bg-white' : 'bg-stone-50 hover:bg-stone-100'
                          }`}
                      >
                        {activeFeature === i && (
                  ...
                  {FEATURES.map((f, i) => (
                    <div key={f.id}>
                      <button
                        ...
                        className={`flex items-center gap-3 w-full px-4 py-4 text-left transition-colors ${activeFeature === i ? 'bg-white' : 'bg-stone-50'
                          }`}
                      >
